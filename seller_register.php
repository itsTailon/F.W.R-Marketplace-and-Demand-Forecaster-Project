...
<html lang="en">
    ...
    <body>
        <div class="login-form">
            ...
            <h1 class="login-form__title">Seller Application</h1>
            ...
            <button class="button button--text-align-left button-submit white" id="customer-register-btn">> Customer Sign Up</button>
        </div>
        ...
        <script src="/assets/js/seller_register.js"></script>
    </body>
</html>
